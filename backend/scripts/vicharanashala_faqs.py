"""Vicharanashala FAQ data.

Auto-generated from the Vicharanashala FAQ source (v24.1.0, 2026-05-29).
This file contains the canonical, verbatim FAQ text from the Vicharanashala
Internship programme, organised by section. It is used by the demo seed
to populate the CrowdMind knowledge base with real, organisation-supplied
content.

Do not edit by hand - regenerate with `python scripts/parse_vins_source.py`.
"""
...
VICHARANASHALA_FAQS: list[FAQEntry] = [
    {
    ...
    },
    {
        ...
        "answer": "Yes. Three things are required, all on the NOC format we provide: the authorised signatory's handwritten signature, the institutional rubber stamp / seal applied in the designated area, and the signatory's email address filled in the designated field — we automatically cross-check with that person to verify the signature is genuine. Digital signatures are not accepted on the PDF path. If a physically- signed printout is impractical for your HOD, use the email-forward path in 5.7 below — it is fully equivalent.",
    },
    {
        "section": 'NOC (No Objection Certificate)',
    ...
    },
    {
        ...
        "answer": 'Yes, in a positive way. Interns who build up higher Spurti Points may, from time to time, become eligible for small perks or recognition from the programme team. Think of a higher SP as a pleasant upside to aim for, never as a penalty to fear.',
    },
    {
        "section": 'Spurti Points',
        "question": 'If SP does not determine outcomes, what does?',
        "answer": 'Your attendance and live participation are what the programme watches closely and tracks strictly. A low SP number is not a cue to ease off. The programme has clear participation requirements that are monitored independently of SP (see §10.7 for the exact thresholds).',
    },
    {
        "section": 'Spurti Points',
        "question": 'What are the participation requirements tracked strictly?',
        "answer": 'Looking at your most recent five working days on a rolling basis, every intern is expected to meet all three of the following: Stay present for at least 85% of the total live Zoom session time. Respond to at least 85% of the polls and quizzes run during the sessions. Attempt every quiz and clear each with a score of at least 50%. All three requirements apply simultaneously. Falling short on even one of them counts.',
    },
    {
        "section": 'Spurti Points',
    ...
    },
    {
        ...
        "answer": 'Link for the website: https://vibe.vicharanashala.ai/auth Sign up as a student with the registered mail ID into the ViBe platform. To log in to the ViBe platform, follow the steps below carefully: ``` Log in to the ViBe platform as a student from registered email ID Check the "Notifications" tab in the Top right side of the Dashboard. Accept the course invite sent for your respective MERN Course. ``` ⚠️ Logging in with a different email ID may result in access issues or missing course visibility.',
    },
    {
        "section": 'ViBe Platform',
    ...
    },
    {
        ...
        "answer": 'Try these troubleshooting steps in order: Refresh the page and check multiple times Inspect browser console: Right-click → Inspect → Go to Network or Console tab → Try watching the video and check for any visible errors Log out and log in again Use a different browser Clear browsing data and cache, then try to re-login If the issue persists after trying all steps, record the issue and contact Yaksha for any queries by mentioning #escalate-ViBe.',
    },
    {
        "section": 'ViBe Platform',
    ...
    },
    {
        ...
        "answer": 'ViBe quizzes come in four formats: Format What it looks like What to do Pick one (MCQ) One right answer out of four or so options Read all the options before clicking Pick one or more (MSQ) "Select all that apply" — could be one correct option or several Read each option carefully; small mistakes happen here most Type a number (NAT) A text box asking for a numeric value Type just the number — no units or extra symbols, unless the question explicitly asks True or False A statement with only two options — True or False Read the statement carefully; a single word like "always," "never," or "only" can flip the correct answer A small tip: watch the clip first, then answer. Trying to read the question while the clip is still playing splits your attention.',
    },
    {
        "section": 'ViBe Platform',
