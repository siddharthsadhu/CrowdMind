    ...
    const timer = setTimeout(async () => {
      ...
      try {
        ...
        if (metrics.length >= 5) {
          ...
          // Draft Updates / Candidates Queue Count
        ...
        // 2. Populate Published FAQs Table
        ...
        if (tbody && faqRes.items.length > 0) {
          ...
          if (templateRow) {
            ...
            faqRes.items.forEach((faq) => {
              ...
              // Resolve category name from list
        ...
        // Update entry description counter
        ...
        // 3. Populate FAQ Candidates Queue inside Sidebar
