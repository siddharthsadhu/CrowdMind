...
<nav class="hidden md:flex gap-6"><a class="text-primary transition-colors text-label-md font-label-md" href="#">FAQs</a>
<a class="text-on-surface-variant hover:text-primary transition-colors text-label-md font-label-md" href="#">Discussions</a>
<a class="text-on-surface-variant hover:text-primary transition-colors text-label-md font-label-md" href="#">Ask Question</a>
<a class="text-on-surface-variant hover:text-primary transition-colors text-label-md font-label-md" href="#">Analytics</a></nav>
</div>
