...
<a class="text-on-surface-variant font-medium hover:text-on-surface transition-colors" href="#">FAQs</a>
<a class="text-on-surface-variant font-medium hover:text-on-surface transition-colors" href="#">Discussions</a>
<a class="text-on-surface-variant font-medium hover:text-on-surface transition-colors" href="#">Ask Question</a>
<a class="text-on-surface-variant font-medium hover:text-on-surface transition-colors" href="#">Analytics</a>
</nav>
</div>
...
<h1 class="font-display text-headline-lg text-on-surface">Alex Rivera</h1>
<span class="text-on-surface-variant font-label-md">@arivera</span>
<span class="px-3 py-1 bg-primary/10 text-primary text-xs font-label-sm rounded-full border border-primary/20">Knowledge Curator</span>
</div>
<p class="font-body-md text-on-surface-variant mb-4 max-w-2xl">
...
<span class="flex items-center gap-2"><span class="material-symbols-outlined text-base">calendar_today</span> Joined Oct 2023</span>
<span class="flex items-center gap-2"><span class="material-symbols-outlined text-base">military_tech</span> 1,280 Reputation</span>
</div>
</div>
</div>
...
<div class="flex gap-[4px] justify-between min-w-[700px]">
...
<div>
<p class="font-headline-md text-on-surface text-lg">Knowledge Curator</p>
<p class="text-on-surface-variant text-xs font-label-sm">Top 5% of community</p>
</div>
</div>
<div class="space-y-3 mb-6">
<div class="flex justify-between text-[10px] font-label-sm uppercase">
<span>To Expert Contributor</span>
<span class="text-primary font-bold">82%</span>
</div>
<div class="h-1.5 w-full bg-surface-variant rounded-full overflow-hidden">
<div class="h-full bg-primary rounded-full shadow-[0_0_8px_rgba(176,198,255,0.6)]" style="width: 82%"></div>
</div>
</div>
...
<span class="text-primary font-display text-xl">#248</span>
</div>
</div>
