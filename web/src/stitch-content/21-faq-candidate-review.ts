...
<a class="font-body-md text-on-surface-variant font-medium hover:text-primary transition-all duration-200 ease-out active:scale-95" href="/library">FAQs</a>
<a class="font-body-md text-on-surface-variant font-medium hover:text-primary transition-all duration-200 ease-out active:scale-95" href="/discussions">Discussions</a>
<a class="font-body-md text-on-surface-variant font-medium hover:text-primary transition-all duration-200 ease-out active:scale-95" href="/ask">Ask Question</a>
<a class="text-primary font-bold border-b-2 border-primary pb-1 font-body-md transition-all duration-200 ease-out" href="/analysis">Analytics</a>
</nav>
</div>
