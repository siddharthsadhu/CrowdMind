...
<a class="text-primary font-bold border-b-2 border-primary pb-1" href="/analysis">Analytics</a>
</div>
</div>
...
<div class="mt-6 flex flex-wrap items-center gap-3 glass-card rounded-xl p-4">
...
<select data-cm-faq-selector class="flex-1 min-w-[280px] bg-surface-container-low border border-outline-variant/30 rounded-lg px-4 py-2 text-label-md focus:ring-1 focus:ring-primary focus:outline-none">
<option value="">Loading knowledge artifacts…</option>
</select>
<button data-cm-refresh title="Refresh timeline" class="flex items-center gap-2 bg-primary/10 border border-primary/20 text-primary px-4 py-2 rounded-lg text-label-md hover:bg-primary/20 transition-all">
...
<div data-cm-insights class="glass-card rounded-xl p-4 space-y-4">
...
<section data-cm-timeline-list class="md:col-span-6 relative flex flex-col items-center hidden"><div class="relative z-10 w-full mb-12">
...
<div data-cm-timeline-line class="evolution-line absolute top-0 bottom-0 z-0 hidden"></div>
<div data-cm-timeline-empty class="glass-card rounded-xl p-8 text-center text-on-surface-variant font-body-md w-full">
<span class="material-symbols-outlined text-primary text-[40px] mb-2">timeline</span>
<p>Select a knowledge artifact above to view its evolution timeline.</p>
</div>
...
<p data-cm-metric-accuracy class="text-headline-md text-primary">98.4%</p>
</div>
<div class="relative h-12 w-12">
<svg class="h-full w-full -rotate-90" viewBox="0 0 36 36">
<circle class="stroke-surface-variant" cx="18" cy="18" fill="none" r="16" stroke-width="3"></circle>
<circle data-cm-metric-accuracy-ring class="stroke-primary" cx="18" cy="18" fill="none" r="16" stroke-dasharray="98.4, 100" stroke-linecap="round" stroke-width="3"></circle>
</svg>
</div>
</div>
...
<span data-cm-metric-agreement-delta class="text-secondary-fixed-dim text-label-sm">+2.1%</span>
</div>
<p data-cm-metric-agreement class="text-headline-md text-on-surface">89%</p>
</div>
<div class="glass-card rounded-xl p-5">
<div class="flex justify-between items-center mb-2">
...
<p data-cm-metric-frequency class="text-headline-md text-on-surface">3.2 <span class="text-label-sm text-on-surface-variant">v/mo</span></p>
</div>
...
<span data-cm-metric-stability-badge class="flex items-center gap-1 px-2 py-0.5 rounded-full bg-primary/10 text-primary text-[10px] font-bold ring-1 ring-primary/20">
<span class="h-1.5 w-1.5 rounded-full bg-primary animate-pulse"></span>
        STABLE
    </span>
</div>
<div class="w-full bg-surface-variant h-2 rounded-full mt-3 overflow-hidden">
<div data-cm-metric-stability-bar class="bg-primary h-full w-[76%] shadow-[0_0_10px_rgba(176,198,255,0.5)]"></div>
</div>
<div class="flex justify-between items-center mt-3">
<p class="text-label-sm text-outline">Trend: +4.2%</p>
<p data-cm-metric-stability-score class="text-label-sm text-on-surface font-bold">76% Score</p>
</div></div>
</aside>
</div>
<!-- Bottom Section: Interactive Version Comparison -->
<section data-cm-diff-section class="mt-section-gap">
<div class="flex items-center justify-between mb-6">
<div>
<h2 class="font-headline-lg text-on-surface text-[24px]">Knowledge Diff Viewer</h2>
<p data-cm-diff-caption class="font-body-md text-on-surface-variant">Comparing Version 2.0 vs Version 3.0</p>
</div>
<div class="flex flex-wrap items-center gap-3">
<label class="font-label-sm text-on-surface-variant flex items-center gap-1">
<span>From</span>
<select data-cm-diff-from class="bg-surface-container-low border border-outline-variant/30 rounded-lg px-3 py-2 text-label-md focus:ring-1 focus:ring-primary focus:outline-none min-w-[100px]">
<option value="">…</option>
</select>
</label>
<label class="font-label-sm text-on-surface-variant flex items-center gap-1">
<span>→</span>
<select data-cm-diff-to class="bg-surface-container-low border border-outline-variant/30 rounded-lg px-3 py-2 text-label-md focus:ring-1 focus:ring-primary focus:outline-none min-w-[100px]">
<option value="">…</option>
</select>
</label>
<button data-cm-rollback disabled class="bg-surface-container-high border border-outline-variant px-4 py-2 rounded-lg text-label-md flex items-center gap-2 hover:bg-surface-variant transition-all disabled:opacity-50 disabled:cursor-not-allowed">
<span class="material-symbols-outlined text-sm">settings_backup_restore</span>
                        Rollback
                    </button>
<button data-cm-diff-approve class="bg-primary text-on-primary px-4 py-2 rounded-lg text-label-md font-bold hover:brightness-110 transition-all">
                        Approve Change
                    </button>
</div>
</div>
...
<span data-cm-diff-from-label class="font-label-md text-outline">v2.0 · Legacy</span>
</div>
<h5 data-cm-diff-from-title class="font-headline-md text-on-surface mb-4">Security Policy &amp; Access Control</h5>
<div data-cm-diff-from-body class="font-body-md text-on-surface-variant space-y-4 leading-relaxed">
...
<span data-cm-diff-to-label class="font-label-md text-primary">v3.0 · Active Evolution</span>
</div>
<h5 data-cm-diff-to-title class="font-headline-md text-on-surface mb-4">Security Policy &amp; Access Control</h5>
<div data-cm-diff-to-body class="font-body-md text-on-surface-variant space-y-4 leading-relaxed">
...
<li><a class="hover:text-secondary transition-colors" href="/evolution">Evolution</a></li>
<li><a class="hover:text-secondary transition-colors" href="/analysis">Analytics</a></li>
...
<ul class="space-y-2 text-on-surface-variant font-label-sm">
<li><a class="hover:text-secondary transition-colors" href="/discussions">Discussions</a></li>
